...
docker login container-registry.oracle.com
# docker build -f ./Dockerfiles/Dockerfile.jvm -t localhost/primes:openjdk .
docker build -f ./Dockerfiles/Dockerfile.graalee -t localhost/primes:graalee .

# Added by Jun 2022/08/14
